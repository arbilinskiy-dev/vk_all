...
export const CalendarHeaderOverview: React.FC<ContentProps> = ({ title }) => {
    return (
        <article className="prose prose-indigo max-w-none">
            ...
            <Sandbox
                title="Интерактивная шапка календаря"
                description="Попробуй нажать на кнопки навигации, переключить режимы, открыть панель обновления и включить режим выбора."
                instructions={["Нажми стрелки навигации или 'Сегодня'", "Переключи режим 'Неделя' / 'Сегодня'", "Открой панель 'Обновить' справа", "Включи режим 'Выбрать' и посмотри на панель действий"]}
            >
            ...
            <div className="not-prose space-y-4 my-8">
                <details className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                    <summary className="font-bold text-gray-900 cursor-pointer">Почему навигация сделана одним блоком, а не отдельными кнопками?</summary>
                    <p className="text-sm text-gray-700 mt-2">
                        Единый блок навигации (стрелки назад/вперёд + "Сегодня") создаёт визуальную группу и показывает, 
                        что это связанные действия для перемещения по времени. Это стандартный UX-паттерн для календарей.
                    </p>
                </details>

                <details className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                    <summary className="font-bold text-gray-900 cursor-pointer">В чём разница между двумя кнопками управления тегами?</summary>
                    <p className="text-sm text-gray-700 mt-2">
                        Первая кнопка (иконка бирки) открывает всплывающее окно для полного управления тегами: создание, 
                        редактирование цветов, удаление. Вторая кнопка (иконка глаза) просто переключает видимость всех тегов 
                        в календаре — быстрое действие без открытия окна.
                    </p>
                </details>

                <details className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                    <summary className="font-bold text-gray-900 cursor-pointer">Почему панель обновления выезжает горизонтально, а не выпадает вниз?</summary>
                    <p className="text-sm text-gray-700 mt-2">
                        Горизонтальная панель справа экономит вертикальное пространство и не перекрывает календарь. 
                        Это особенно важно при работе с большими экранами, где ширина избыточна, а высота ценна.
                    </p>
                </details>

                <details className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                    <summary className="font-bold text-gray-900 cursor-pointer">Зачем нужна отдельная кнопка создания заметки, если можно дважды кликнуть по ячейке?</summary>
                    <p className="text-sm text-gray-700 mt-2">
                        Кнопка с иконкой карандаша — это более очевидный и быстрый способ создания заметки прямо на текущую дату. 
                        Двойной клик по ячейке подходит для создания заметки на конкретную дату в будущем/прошлом, 
                        а кнопка — для "здесь и сейчас".
                    </p>
                </details>
            </div>
            ...
            <div className="not-prose bg-gray-100 border border-gray-300 rounded-lg p-6 my-8">
                ...
                <ul className="space-y-2 text-sm text-gray-700">
                    <li className="flex items-start gap-2">
                        ...
                        <span><strong>7 ключевых инструментов</strong> для навигации, поиска, просмотра и управления контентом.</span>
                    </li>
                    <li className="flex items-start gap-2">
                        <span className="text-indigo-600 font-bold">•</span>
                        <span><strong>Логичное разделение:</strong> левая часть (навигация, режимы, поиск) и правая часть (действия, видимость, обновление).</span>
                    </li>
                    <li className="flex items-start gap-2">
                        <span className="text-indigo-600 font-bold">•</span>
                        <span><strong>Умная анимация:</strong> выезжающие панели для обновления и массовых действий экономят место.</span>
                    </li>
                    <li className="flex items-start gap-2">
                        <span className="text-indigo-600 font-bold">•</span>
                        <span><strong>Покрытие всех сценариев:</strong> от простого перемещения до сложных массовых операций.</span>
                    </li>
                    <li className="flex items-start gap-2">
                        <span className="text-indigo-600 font-bold">•</span>
                        <span><strong>Интуитивное расположение:</strong> самое используемое слева, редкое справа.</span>
                    </li>
                </ul>
            </div>
