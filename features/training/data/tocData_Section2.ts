// Раздел 2: Модуль "Контент-менеджмент" — самый большой раздел
import type { TocItem } from './tocData_types';

export const tocSection2: TocItem = {
            ...
            children: [
                ...
                },
                {
                    ...
                    children: [
                        ...
                        { title: 'Логи конкурса', path: '2-4-2-9-logs' },
                    ]
                },
                {
                    title: '2.4.3. Дроп промокодов (планируется)',
                ...
                {
                    title: '2.4.6. Поздравления с ДР (планируется)',
                    path: '2-4-6-birthday',
                    children: [
                ...
                {
                    title: '2.4.7. Конкурс "Актив" (планируется)',
                ...
                {
                    title: '2.4.8. Конкурс 2.0',
                    path: '2-4-8-contest-v2',
                    children: [
                        { title: 'Обзор функционала', path: '2-4-8-1-overview' },
                        { title: 'Список конкурсов', path: '2-4-8-2-contests-list' },
                        { title: 'Создание конкурса', path: '2-4-8-3-create' },
                        { title: 'Вкладка «Настройки»', path: '2-4-8-4-settings-tab' },
                        { title: 'Вкладка «Пост-старт»', path: '2-4-8-5-post-start-tab' },
                        { title: 'Вкладка «Условия участия»', path: '2-4-8-6-conditions-tab' },
                        { title: 'Вкладка «Пост итоги»', path: '2-4-8-7-results-tab' },
                        { title: 'Превью конкурса', path: '2-4-8-8-preview' },
                    ]
                },
            ]
        },
